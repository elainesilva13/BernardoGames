...
outro_float = 1.7777777777777777777777777777777
print(outro_float)
print(type(outro_float))
outro_int = int(outro_float) # pegou a parte INTEIRA do float (a parte ANTES do .)
print(outro_int)
print(type(outro_int))
print(round(outro_float,2)) # arredondou conforme regras matemáticas = se o primeiro número depois do ponto for de 0 a 4, arredonda para menos, se entre 5 e 9, para mais
